    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit"onclick="addproducts" name="submit" value="submit" class="btn btn-success float-right">
        </div>
      </div>
          </form>
    </section>
...
<?php
      ...
      {
        addProduct($conn,$_POST['pid'], $_POST['cid'], $_POST['pdes'],$_POST['sdes'],$_POST['price'], $_POST['discount'] ,
